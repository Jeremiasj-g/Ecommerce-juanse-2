...
<section class="container container-table-productos mt-3 mb-3">
    ...
    <div class="d-flex justify-content-end">
        <a href="<?php echo base_url('consulta_contactos') ?>" class="btn-success btn-sm m-2 btn-opciones">No leidos</a>
        <a href="<?php echo base_url('consulta_no_leidos') ?>" class="btn btn-dark btn-sm m-2 btn-opciones">Leidos</a>
    </div>
